...
<body class="bg-canvas text-ink antialiased overflow-x-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                <div class="flex items-center gap-3 animate-slideInLeft">
                    <div
                        class="w-8 h-8 bg-ink rounded-lg flex items-center justify-center shrink-0 transform hover:rotate-12 transition-transform duration-300">
                        <svg width="800px" height="800px" viewBox="0 0 32 32" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_901_3008)">
                                <path
                                    d="M31 6V11V16V21V26V31H12C18.07 31 23 26.07 23 20C23 13.93 18.07 9 12 9C10.23 9 8.56 9.42 7.08 10.16L7 10V1H31V6Z"
                                    fill="#668077" />
                                <path
                                    d="M12 9C18.07 9 23 13.93 23 20C23 26.07 18.07 31 12 31C5.93 31 1 26.07 1 20C1 15.7 3.48 11.97 7.08 10.16C8.56 9.42 10.23 9 12 9Z"
                                    fill="#FFC44D" />
                                <path
                ...
                <div class="flex items-center gap-3 animate-fadeInUp">
                    @auth
                        <a href="{{ route('dashboard') }}"
                            ...
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 14 14"
                    ...
                    @else
                        ...
                        <a href="{{ route('register') }}"
                            ...
                            Get Started
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 12 12"
                                stroke-linecap="round">
    ...
    <section class="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        <div class="absolute inset-0 -z-10">
            <div class="absolute top-20 left-10 w-72 h-72 bg-finance-green/10 rounded-full blur-3xl animate-float">
            </div>
            <div class="absolute bottom-20 right-10 w-96 h-96 bg-finance-blue/10 rounded-full blur-3xl animate-float"
        ...
        <div class="max-w-7xl mx-auto">
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 opacity-0 animate-fadeInUp delay-200">
                        @auth
                            <a href="{{ route('dashboard') }}"
                                ...
                                Go to Dashboard
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 12 12"
                                    stroke-linecap="round">
                                    <path d="M2 6h8M7 3l3 3-3 3" />
                                </svg>
                            </a>
                ...
                <div class="relative opacity-0 animate-fadeInUp delay-400">
                    <div
                        class="relative z-10 bg-surface border border-edge rounded-2xl shadow-2xl overflow-hidden transform hover:scale-105 transition-transform duration-500">
                        ...
                        <div class="p-6 space-y-4">
                            <div class="grid grid-cols-2 gap-3">
                                <div class="bg-finance-green-bg border border-finance-green-border p-4 rounded-lg">
                                    <div
                                        class="text-[10px] font-bold text-finance-green uppercase tracking-widest mb-1">
                                        Income</div>
                                ...
                                <div class="bg-finance-red-bg border border-finance-red-border p-4 rounded-lg">
                                    <div class="text-[10px] font-bold text-finance-red uppercase tracking-widest mb-1">
                                        Expenses</div>
                    ...
                    <div class="absolute -bottom-4 -right-4 w-32 h-32 bg-finance-blue/20 rounded-full blur-2xl -z-10">
                    </div>
                    <div class="absolute -top-4 -left-4 w-32 h-32 bg-finance-green/20 rounded-full blur-2xl -z-10">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="card-hover bg-white border border-edge rounded-xl p-8 opacity-0 animate-fadeInUp delay-100">
                    <div
                        class="w-14 h-14 bg-finance-green-bg border border-finance-green-border rounded-xl flex items-center justify-center mb-6">
                        <svg class="w-7 h-7 text-finance-green" fill="none" stroke="currentColor" stroke-width="1.5"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4" />
                        </svg>
                    </div>
                    <h3 class="text-xl font-semibold mb-3">Track Expenses</h3>
                    <p class="text-ink-2 leading-relaxed">Record and categorize every transaction with ease. Know
                        exactly where your money goes.</p>
                </div>

                <div class="card-hover bg-white border border-edge rounded-xl p-8 opacity-0 animate-fadeInUp delay-200">
                    <div
                        class="w-14 h-14 bg-finance-blue-bg border border-finance-blue-border rounded-xl flex items-center justify-center mb-6">
                        <svg class="w-7 h-7 text-finance-blue" fill="none" stroke="currentColor" stroke-width="1.5"
                            viewBox="0 0 24 24">
                    ...
                    <p class="text-ink-2 leading-relaxed">Set monthly budgets for different categories and get alerts
                        when you're close to limits.</p>
                </div>

                <div class="card-hover bg-white border border-edge rounded-xl p-8 opacity-0 animate-fadeInUp delay-300">
                    <div
                        class="w-14 h-14 bg-finance-amber-bg border border-finance-amber-border rounded-xl flex items-center justify-center mb-6">
                        <svg class="w-7 h-7 text-finance-amber" fill="none" stroke="currentColor" stroke-width="1.5"
                            viewBox="0 0 24 24">
                    ...
                    <p class="text-ink-2 leading-relaxed">Beautiful charts and graphs to understand your spending
                        patterns at a glance.</p>
                </div>

                <div class="card-hover bg-white border border-edge rounded-xl p-8 opacity-0 animate-fadeInUp delay-100">
                    <div
                        class="w-14 h-14 bg-finance-red-bg border border-finance-red-border rounded-xl flex items-center justify-center mb-6">
                        <svg class="w-7 h-7 text-finance-red" fill="none" stroke="currentColor" stroke-width="1.5"
                            viewBox="0 0 24 24">
                    ...
                    <p class="text-ink-2 leading-relaxed">Manage bank accounts, cash, credit cards, and wallets all in
                        one place.</p>
                </div>
                ...
                <div class="card-hover bg-white border border-edge rounded-xl p-8 opacity-0 animate-fadeInUp delay-200">
                    ...
                    <p class="text-ink-2 leading-relaxed">Keep track of money lent and borrowed. Never forget who owes
                        what.</p>
                </div>
                ...
                <div class="card-hover bg-white border border-edge rounded-xl p-8 opacity-0 animate-fadeInUp delay-300">
                    ...
                    <p class="text-ink-2 leading-relaxed">Download your financial data as CSV for further analysis or
                        backup.</p>
                </div>
            </div>
        </div>
    ...
    <section class="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        <div class="absolute inset-0 bg-linear-to-br from-finance-blue/5 to-finance-green/5"></div>
